...
install.packages(c("stats", "e1071", "car"))
library("stats")
library("e1071")
library("car")
...
h <- hist(wiek,5,main="Histogram zmiennej wiek", ylab="liczebności")
...
# wykres skrzypcowy
violplot(wiek[plec=="mezczyzna"], wiek[plec=="kobieta"], wiek, names=c("wiek M", "wiek K", "wiek"))

# wykres rozrzutu
sp(cisnienie.skurczowe,cisnienie.rozkurczowe,groups=plec,smooth=FALSE, lwd=3, pch=c(20,21), cex=1.5)
